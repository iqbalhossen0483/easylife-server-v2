...
describe('TransactionService', () => {
  ...
  describe('acceptTransfer', () => {
    ...
    it('should handle BALANCE_TRANSFER correctly', async () => {
      ...
      expect(result.success).toBe(true);
      expect(mockRepo.decrement).toHaveBeenCalledWith({ id: 1 }, 'have_money', 5000);
      expect(mockRepo.increment).toHaveBeenCalledWith({ id: 2 }, 'have_money', 5000);
    });
    ...
    it('should handle SALARY correctly', async () => {
      ...
      expect(result.success).toBe(true);
      expect(mockRepo.decrement).toHaveBeenCalledWith({ id: 1 }, 'have_money', 5000);
      expect(mockRepo.increment).toHaveBeenCalledWith({ id: 2 }, 'get_salary', 5000);
    });
    ...
    it('should handle INCENTIVE correctly', async () => {
      ...
      expect(mockRepo.decrement).toHaveBeenCalledWith({ id: 1 }, 'have_money', 5000);
      expect(mockRepo.increment).toHaveBeenCalledWith({ id: 2 }, 'incentive', 5000);
    });
    ...
    it('should throw if transfer not found', async () => {
      ...
      await expect(service.acceptTransfer(999, 2)).rejects.toThrow(NotFoundException);
    });
  });
