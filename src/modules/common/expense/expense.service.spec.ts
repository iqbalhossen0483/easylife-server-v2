...
describe('ExpenseService', () => {
  ...
  describe('submitExpense', () => {
    it('should auto-approve for super_admin', async () => {
      ...
      expect(mockReportService.updateCashReport).toHaveBeenCalledWith('expense', 5000);
    });
  ...
  describe('approveExpense', () => {
    ...
    it('should throw if expense not found', async () => {
      ...
      await expect(service.approveExpense(999, 1)).rejects.toThrow(NotFoundException);
    });
  });
  ...
  describe('rejectExpense', () => {
    ...
    it('should throw if not pending', async () => {
      ...
      await expect(service.rejectExpense(1)).rejects.toThrow(BadRequestException);
    });
  });
